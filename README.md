...
- Info & stats: select any unit or building to read its function, costs and combat stats. The roster has eight units: Harvester, Vanguard, Ranger, Breaker, Medic, Engineer, Battle tank and Anti-tank soldier. Medics heal infantry; Engineers repair completed buildings, Breakers and Battle tanks. Barracks L2 unlocks Anti-tank soldiers; Foundry L3 unlocks Battle tanks. See [heavy weapon stats](docs/HEAVY_WEAPONS.md). Use Support → friendly target, or keep them near injured allies for automatic support.
